...
import {
  ExportAllAttractions,
  ImportExampleAttractions,
  ImportAttractions,
} from "@/api/attraction";

interface AttractionImportExportDialogProps {
  isOpen: boolean;
  onClose: () => void;
...
export const AttractionImportExportDialog = ({
  isOpen,
  onClose,
  onImportSuccess,
  trigger,
}: AttractionImportExportDialogProps) => {
  ...
  const handleDownloadTemplate = async () => {
    ...
    try {
      ...
      const link = document.createElement("a");
      link.href = url;
      link.download = "attractions-import-template.xlsx";
      document.body.appendChild(link);
      link.click();
      document.body.removeChild(link);
      window.URL.revokeObjectURL(url);

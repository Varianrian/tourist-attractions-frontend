              ...
              {isLoading ? (
                ...
                transportationsData.map((item: Transportation, index: number) => (
                  ...
                  >
                    ...
                    <Table.Cell>
                      <Badge
                        colorScheme={typeColors[item.type].color}
                        borderRadius="md"
                        px={{ base: 1, md: 2 }}
                        py={{ base: 0.5, md: 1 }}
                        ...
                        <HStack columnGap={2}>
                          ...
                          src={`https://img.icons8.com/?size=${window.innerWidth < 768 ? 16 : 20}&id=${
                            item.type === "HARBOR"
                              ...
                              : item.type === "AIRPORT"
                                ? "12665"
                                : item.type === "TRAIN_STATION"
                                  ? "9361"
                                  : item.type === "BUS_STATION"
                                    ? "9351"
                                    : "62215"
                          }&format=png&color=${filterColors[item.type].split("#")[1]}`}
                          alt={item.type}
                          style={{ width: "16px", height: "16px" }}
                          />
        ...
        >
          <Text fontSize="sm" color="gray.600" fontWeight="medium">
            {isLoading ? (
              ...
              `Showing ${transportationsData.length} of ${metaData?.total || 0} results`
            )}
          </Text>
